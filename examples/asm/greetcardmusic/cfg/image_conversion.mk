...
## Firmware palette definition as variable (16 firmware values as colours)
## Selected colours (index 0 will be background colour):
## ||================================||=================================||
## ||    |FIRM |                     ||    |FIRM |                      ||
## || IDX|VALUE| COLOUR NAME  (RGB)  || IDX|VALUE| COLOUR NAME   (RGB)  || 
## ||================================||=================================||
## ||  0 | 14  |Pastel Blue (#8080FF)||  8 | 13  |White        (#808080)||
## ||  1 |  0  |Black       (#000000)||  9 | 16  |Pink         (#FF8080)||
## ||  2 |  3  |Red         (#800000)|| 10 | 23  |Pastel Cyan  (#80FFFF)||
## ||  3 |  4  |Magenta     (#800080)|| 11 | 26  |Bright White (#FFFFFF)||
## ||  4 |  9  |Green       (#008000)|| 12 |  6  |Bright Red   (#FF0000)||
## ||  5 | 10  |Cyan        (#008080)|| 13 | 15  |Orange       (#FF8000)||
## ||  6 | 11  |Sky Blye    (#0080FF)|| 14 | 18  |Bright Green (#00FF00)||
## ||  7 | 12  |Yellow      (#808000)|| 15 | 24  |Bright Yellow(#FFFF00)||
## ||================================||=================================||
PALETTE={14 0 3 4 9 10 11 12 13 16 23 26 6 15 18 24}

## Image assets/octopusjig.png conversion
##    This will convert assets/octopusjig.png into src/octopusjig.{c|h} files.
##    A C-array called g_octopusjig[45*133] will be generated with the definition
##    of the image octopusjig.png in mode 0 screen pixel format, without interlaced mask.
##    The palette used for conversion is given through the PALETTE variable and
##    a g_palette[16] array will be generated with the 16 palette colours as 
##	   hardware colour values.
##
$(eval $(call IMG2SPRITES,assets/octopusjig.png,0,g,90,133,$(PALETTE),,src/,hwpalette))