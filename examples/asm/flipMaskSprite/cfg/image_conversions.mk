...
## 0 = BLACK 16 = PINK, 25 = PASTEL_YELLOW, 26 = WHITE
PALETTE={0 16 25 26}

## Convert img/background.png into src/background.c and src/background.h
##   This file contains a complete mode 1, 320x200 pixels, background image. The image 
## will be converted into 16 C-arrays (80x50 pixels each), called g_background{0-15} 
## that could be considered some sort of "tiles". A g_tileset array will also be 
## generated, containing pointers to all 16 tiles, ordered from 0 to 15. Sprites
## will be generated in screen mode 1 pixel format, without interlaced mask. 
## Conversion will also output an array called g_palette with the 4 hardware colour 
## values that define the given PALETTE.
$(eval $(call IMG2SPRITES,img/background.png,1,g,80,50,$(PALETTE),tileset,src/,hwpalette))

## Convert img/knight.png into src/knight.c and src/knight.h
