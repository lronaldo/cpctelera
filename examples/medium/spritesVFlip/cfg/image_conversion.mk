...
## Firmware palette definition for this example. Only 7 colours are 
## actually used. The rest are left as 0, but they could be anything.
PALETTE={0 1 3 6 15 24 26 0 0 0 0 0 0 0 0 0}

## Automatically convert img/rocket.png into src/rocket.c & src/rocket.h.
## As this is a Makefile macro, this conversion will be automatically 
## performed each time rocket.png is changed or rocket.c/rocket.h are 
## missing. It will generate g_rocket array with mode 0 screen pixel values
## without mask. g_rocket will be of size [4*14], because each byte
...
$(eval $(call IMG2SPRITES,img/rocket.png,0,g,8,14,$(PALETTE),,src/,hwpalette))