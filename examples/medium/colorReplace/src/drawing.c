...
void ColorSprite(u8 color)
{
    ...
    cpct_setSpriteColourizeM0_f(1, color);
    cpct_spriteColourizeM0_f(G_BALOON_W, G_BALOON_H, gSpriteColorized); // Colors are consecutives

    cpct_setSpriteColourizeM0_f(2, color + 1);
    cpct_spriteColourizeM0_f(G_BALOON_W, G_BALOON_H, gSpriteColorized);
