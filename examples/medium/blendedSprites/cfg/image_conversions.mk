...
## Convert src/img/scifi_bg.png into src/scifi.{c|h}
##   Image is a background of size 160x128 pixels. However, as cpct_drawSprite 
##   function cannot draw sprites wider than 63 bytes (126 mode 0 pixels),
##   we convert the function into 2 arrays of size 80x128, which will be 
##   named g_scifi_bg_0 and g_scifi_bg_1 (g is a prefix for variable names).
$(eval $(call IMG2SPRITES,src/img/scifi_bg.png,0,g,80,128,$(PALETTE),,src/))

## Convert src/img/items.png into src/items.{c|h}
##   Image contains 4 8x8 pixels sprites for mode 0. Giving the size of one
##   sprite, we will get the 4 of them as 4 arrays named g_items_0 ... g_items_3
##   (g is a prefix for variable names).
