...
void drawBackground() {
   ...
   u8* p = cpctm_screenPtr(CPCT_VMEM_START, BG_X, BG_Y);
...
void drawUserInterfaceStatus() {
   ...
   u8 *p = cpctm_screenPtr(CPCT_VMEM_START, 4, 60);
   ...
   p = cpctm_screenPtr(CPCT_VMEM_START, 52, 60);
...
void drawUserInterfaceMessages() {
   ...
   p = cpctm_screenPtr(CPCT_VMEM_START, 0, 15);
   ...
   p = cpctm_screenPtr(CPCT_VMEM_START, 0, 30);
   ...
   p = cpctm_screenPtr(CPCT_VMEM_START, 0, 50);
