...
TARGET  := tilemaps tilesets $(CDT) $(DSK)
...
# CFiles that will be generated even if now they are not present
GEN_CFILES := $(SRCDIR)/tiles.c
...
CFILES     := $(filter-out $(GEN_CFILES),$(foreach DIR, $(SUBDIRS), $(wildcard $(DIR)/*.$(C_EXT)))) $(GEN_CFILES)
