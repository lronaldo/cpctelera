...
## Converting background tilemap
## 		Convert img/map.tmx to src/map.{c|h} files.
##		map.tmx contains a tilemap created with Tiled that uses tiles
## 		in img/tiles.png. This macro will convert the tilemap into a C-array
## 		named g_background, containing all the IDs of the tiles that are located 
## 		at each given location of the C-array (ranging from 0 to tiles-1).
##
$(eval $(call TMX2C,img/map.tmx,g_background,src/sprites/))