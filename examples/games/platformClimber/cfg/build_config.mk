...
## Generated code files from assets
##
GENERATED_ASSETS := $(SRCDIR)/sprites/credits.c
...
CFILES         := $(GENERATED_ASSETS) $(foreach DIR, $(SUBDIRS), $(wildcard $(DIR)/*.$(C_EXT)))
