...
## Firmware palette definition for this example. Only 11 colours are 
## actually used. The rest are left as 0, but they could be anything.
PALETTE={0 1 2 5 11 14 18 20 23 25 26 0 0 0 0 0}

## Automatically convert img/sprite.png into src/sprite.c & src/sprite.h.
## As this is a Makefile macro, this conversion will be automatically 
## performed each time sprite.png is changed or sprite.c/sprite.h are 
## missing. It will generate g_sprite array with mode 0 screen pixel values
## without mask. g_sprite will be of size [10*30], because each byte
## contains 2 pixel values for mode 0. It will also generate an array
## called g_palette with hardware colour values conversion of the PALETTE
## firmware values array
$(eval $(call IMG2SPRITES,img/sprite.png,0,g,20,30,$(PALETTE),,src/,hwpalette))
