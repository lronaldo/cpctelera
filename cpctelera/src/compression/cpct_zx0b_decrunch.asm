...
;; might be placed either on RAM or on ROM memory. *destination* array is required to be in
;; RAM, as decompressed data will be written there.
;;
...
;; version, backwards variant) by Einar Saukas.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
dzx0sb_new_offset:
        ...
        call    c, dzx0sb_elias_backtrack ;; [3/5]
        inc     bc                   ;; [2]
        jr      dzx0sb_copy          ;; [3]
dzx0sb_elias_backtrack:
        ...
        rl      b                    ;; [2]
dzx0sb_elias:
        add     a, a                 ;; [1] inverted interlaced Elias gamma coding
        jr      nz, dzx0sb_elias_skip ;; [2/3]
        ld      a, (hl)              ;; [2] load another group of 8 bits
        dec     hl                   ;; [2]
        rla                          ;; [1]
dzx0sb_elias_skip:
        jr      c, dzx0sb_elias_backtrack ;; [2/3]
        ret                          ;; [3]
