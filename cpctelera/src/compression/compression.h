...
extern void cpct_zx0_decrunch   (void* dest_start, const void* source_start) __z88dk_callee;
extern void cpct_zx0b_decrunch  (void* dest_end, const void* source_end) __z88dk_callee;
