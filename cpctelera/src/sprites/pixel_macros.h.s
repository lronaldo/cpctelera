...
;; Macro: CPCTM_PEN2PIXELPATTERN_M0_ASM
;;
...
;;
;; ASM Definition:
;;    .macro <CPCTM_PEN2PIXELPATTERN_M0_ASM> *SYM*, *PEN*
;;
;; Parameters:
...
;;       CPCTM_PEN2PIXELPATTERN_M0_ASM OldPen, 1 ;// Produces 'OldPen = 0xF0'
;;       CPCTM_PEN2PIXELPATTERN_M0_ASM NewPen, 2 ;// Produces 'NewPen = 0x0F'
...
;;       CPCTM_PEN2PIXELPATTERN_M0_ASM OldPen, 2 ;// Produces 'OldPen = 0x0F'
;;       CPCTM_PEN2PIXELPATTERN_M0_ASM NewPen, 1 ;// Produces 'NewPen = 0xF0'
;;       ld    de, #(OldPen << 8) | NewPen
;;       call  cpct_spriteColourizeM0_asm
;;       ret
;; (end code)
...
;;
;; C Definition:
;;    .macro <CPCTM_PENS2PIXELPATTERNPAIR_M0_ASM> *SYM*, *OldPen*, *NewPen*
;;
;; Parameters:
;;    SYM    - Name of a symbol to assign the resulting value of the calculation
...
;; ;// BC = Size of Alien Sprite
;; changeAlienSkinColourToCyan:
;;    CPCTM_PENS2PIXELPATTERNPAIR_M0_ASM rplcPat, 1, 2   ;// Change Pen 1 into Pen 2
...
;; ;// BC = Size of Alien Sprite
;; restoreAlienSkinColourToYellow:
;;    CPCTM_PENS2PIXELPATTERNPAIR_M0_ASM rplcPat, 2, 1   ;// Change Pen 2 into Pen 1
;;    ld    de, #rplcPat                                 ;// rplcPat = 0x0FF0
;;    call  cpct_spriteColourizeM0_asm
;;    ret
;; (end code)
;;
.mdelete CPCTM_PENS2PIXELPATTERNPAIR_M0_ASM
.macro CPCTM_PENS2PIXELPATTERNPAIR_M0_ASM _Sym, _OldPen, _NewPen
   CPCTM_PEN2PIXELPATTERN_M0_ASM _Sym'__h, _OldPen
   CPCTM_PEN2PIXELPATTERN_M0_ASM _Sym'__l, _NewPen
