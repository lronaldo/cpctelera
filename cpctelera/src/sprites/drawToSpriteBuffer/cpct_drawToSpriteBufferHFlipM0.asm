...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Function: cpct_drawToSpriteBufferHFlipM0
;;
;; Draws a Mode 0 sprite from an array inside another sprite's buffer
;; flipping it Horizontally (right to left).
;; This permits using the destination sprite as a temporary screen back buffer.
;;
;; C Definition:
;;    void <cpct_drawToSpriteBufferHFlipM0> (<u16> *buffer_width*, void* *inbuffer_ptr*, 
...
;;    > call cpct_drawToSpriteBufferHFlipM0_asm
;;
...
;;      else
;;         cpct_drawToSpriteBufferHFlipM0(BACK_W, g_background + ch->y*BACK_W + ch->x, ENT_W, ENT_H, g_character);
;;
;;      if (ch->dir == LEFT)
;;         cpct_drawToSpriteBuffer(BACK_W, g_background + en->y*BACK_W + en->x, ENT_W, ENT_H, g_enemy);
;;      else
;;         cpct_drawToSpriteBufferHFlipM0(BACK_W, g_background + en->y*BACK_W + en->x, ENT_W, ENT_H, g_enemy);
;;
;;      cpct_waitVSync();
...
;; See cpct_drawSpriteHFlipM0 for flipping operation
;;
