...
;;
;; C Definition:
;;    void <cpct_drawSpriteHFlipMasked_at> (const void* *sprite*, void* *memory*, <u8> *width*, <u8> *height*) __z88dk_callee;
;;
...
;;       cpct_drawSpriteHFlipMasked_at(o->sprite, pvmem, o->width, o->height);
;;    }
;; (end code)
;;
