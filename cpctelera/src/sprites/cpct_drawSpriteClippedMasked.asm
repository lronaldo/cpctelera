...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;
;; Function: cpct_drawSpriteClippedMasked
;;
;;    Copies partially a masked sprite from an array to video memory (or to a screen buffer),
;; using mask as transparency information, to prevent erasing the background.
;;
;; C Definition:
;;    void <cpct_drawSpriteClippedMasked> (u8 width_to_draw, void* *sprite*, void* *memory*, <u8> *width*, <u8> *height*) __z88dk_callee;
;;
...
dms_sprite_width_loop:
   ...
   inc  de         ;; [2] Next bytes memory
   inc  hl         ;; [2] Next bytes sprite
   dec   c         ;; [1] C holds sprite width to draw, we decrease it to count pixels in this line.
