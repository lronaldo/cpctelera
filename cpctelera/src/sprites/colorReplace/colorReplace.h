...
// Function to set colors to replace M0
extern void cpct_setReplaceColorsM0(u8 oldColor, u8 newColor) __z88dk_callee;

// Functions to replace a color in sprite M0
extern void cpct_spriteColorizeM0(u8* sprite, u8* spriteColor, u8 width, u8 height) __z88dk_callee;
extern void cpct_spriteMaskedColorizeM0(u8* sprite, u8* spriteColor, u8 width, u8 height) __z88dk_callee;

// Functions to draw a sprite M0 with a color replaced 
extern void cpct_drawSpriteColorizeM0(u8* sprite, u8* destMem, u8 width, u8 height) __z88dk_callee;
extern void cpct_drawSpriteMaskedColorizeM0(u8* sprite, u8* destMem, u8 width, u8 height) __z88dk_callee;
extern void cpct_drawSpriteMaskedAlignedColorizeM0(u8* sprite, u8* destMem, u8 width, u8 height, const u8* maskTable) __z88dk_callee;

// Functions to replace a color in sprite M1
extern void cpct_spriteColorizeM1(u8* sprite, u8* spriteColor, u8 width, u8 height) __z88dk_callee;
