...
;;
;;    Sets the concrete colour that will be replaced by <cpct_spriteColourizeM0_f> when called.
;;
;; C Definition:
;;    void <cpct_setSpriteColourizeM0_f> (<u8> *oldColor*, <u8> *newColor*) __z88dk_callee;
;;
