...
;;
;; C Definition:
;;    void <cpct_setSeed_xsp40_u8> (<u16> *seed8*, <u32> *seed32*) __z88dk_callee;
;;
;; Input Parameters (5 bytes):
;;    (4B DE:HL) *seed32* - Main 32-bits seed for generating pseudo-random numbers
;;    (1B     A) *seed8*  - Secondary seed for the Weyl sequence that improves random quality.
;;
...
;;    * *seed8* can be any 8-bits number. This parameter is passed as 16-bits value
;; (in a C call), but only 8 Least Significan bits are used.
;;
;; Important details:
