...
const std::string C_INVERTED_LIGHT_RED { "\033[1;30;41m" };
const std::string C_INVERTED_LIGHT_GREEN { "\033[1;30;42m" };
const std::string C_INVERTED_LIGHT_YELLOW { "\033[1;30;43m" };
const std::string C_INVERTED_LIGHT_BLUE { "\033[1;30;44m" };
const std::string C_INVERTED_GREEN { "\033[0;39;42m" };
const std::string C_INVERTED_YELLOW { "\033[0;30;43m" };
const std::string C_INVERTED_CYAN { "\033[0;39;46m" };
const std::string C_INVERTED_WHITE { "\033[0;30;47m" };
const std::string C_INVERTED_MAGENTA { "\033[0;31;47m" };
const std::string C_INVERTED_LIGHT_MAGENTA { "\033[1;30;45m" };
const std::string C_INVERTED_LIGHT_WHITE { "\033[1;30;47m" };
const std::string C_RED { "\033[0;31;49m" };
const std::string C_BLUE { "\033[0;34;49m" };
