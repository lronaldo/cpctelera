...
#####
CPCRSLIB_PATH := $(CPCT_PATH)z80libs/cpcrslib_SDCC/
CPCRSLIB_INC  := $(CPCRSLIB_PATH)src/cpcrslib/
CPCRSLIB_LIB  := $(CPCRSLIB_PATH)cpcrslib.lib
CPCWYZLIB_LIB := $(CPCRSLIB_PATH)cpcwyzlib.lib
Z80CCFLAGS    :=
Z80ASMFLAGS   := -l -o -s
Z80CCINCLUDE  := -I$(CPCT_SRC) -I$(CPCRSLIB_INC)
Z80CCLINKARGS := -mz80 --no-std-crt0 -Wl-u \
                 --code-loc $(Z80CODELOC) \
                 --data-loc 0 -l$(CPCT_LIB) -l$(CPCWYZLIB_LIB) -l$(CPCRSLIB_LIB)
####
